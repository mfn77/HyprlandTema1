...
cd $HOME/MFN-Tema1/
cp -Rv $HOME/MFN-Tema1/.config/hpyr $DIR
clear

#Diğer Ayar Dosyalarını Kopyalama
echo -e "\e[1;31m${bold}Diger Ayarlar Esitleniyor${normal}\e[0m"
cp -Rv $HOME/MFN-Tema1/.config/kitty $CONFIG_DIR/
cp -Rv $HOME/MFN-Tema1/.config/gtk-3.0 $CONFIG_DIR/
cp -Rv $HOME/MFN-Tema1/.config/dunst $CONFIG_DIR/
cp -Rv $HOME/MFN-Tema1/.config/swaylock $CONFIG_DIR/
cp -Rv $HOME/MFN-Tema1/.config/nwg-look $CONFIG_DIR/
cp -Rv $HOME/MFN-Tema1/.config/viewnior $CONFIG_DIR/
cp -Rv $HOME/MFN-Tema1/.config/rofi $CONFIG_DIR/
cp -Rv $HOME/MFN-Tema1/.config/wlogout $CONFIG_DIR/
cp -Rv $HOME/MFN-Tema1/.config/waybar $CONFIG_DIR/
cp -Rv $HOME/MFN-Tema1/.config/xsettingsd $CONFIG_DIR/
cp -v $HOME/MFN-Tema1/.config/mimeapps.list $CONFIG_DIR/
cp -Rv $HOME/MFN-Tema1/.local/bin $DIR/.local
cp -Rv $HOME/MFN-Tema1/.wallpapers $DIR
cp -Rv $HOME/MFN-Tema1/.scripts $DIR
cp -v $HOME/MFN-Tema1/.profile $DIR
cp -v $HOME/MFN-Tema1/.autostart $DIR
clear
